...
def stochasticGradientDescend(data, U0, V0, v0, contextFunction, lossAndGradientFunction, batchSize=1000, epochs=1, alpha=1., printInterval=10000):
    ...
    ###  U0, V0, v0 -- начални матрици на влагания и начална стойност на v;
    ...
    while epoch<epochs:
        ...
        for b in range(0,len(idx),batchSize):
            ...
            J, du_w, dVt, dv = lossAndGradientFunction(u_w,Vt,v)
